...
package com.castsoftware.paris.exceptions.neo4j;

import com.castsoftware.paris.exceptions.ExtensionException;

/**
 * The <code>Neo4jBadNodeFormat</code> is thrown when the conversion from a Neo4J node to its
 * associated Java model fail. Neo4jBadNodeFormat
 */
public class Neo4jBadNodeFormatException extends ExtensionException {

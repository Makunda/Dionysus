...
package com.castsoftware.dionysus.exceptions;
 ...
 */
public abstract class ExtensionException extends Throwable {
  ...
  public ExtensionException(String message, Throwable cause, String code) {
    super(message, cause);
  ...
  public ExtensionException(String message, String code) {
    super(message);
